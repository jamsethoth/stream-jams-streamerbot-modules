# first-chat-shoutouts-stream-state Specification

## Purpose

Define how First Chat Shoutouts persists active stream shoutout state, duplicate suppression, and recovery behavior in Streamer.bot globals.
